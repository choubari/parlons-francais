...
export async function sendMagicLink(email: string, url: string): Promise<void> {
  ...
  const html = `
    <div style="font-family:system-ui,sans-serif;max-width:480px;margin:0 auto;padding:24px;color:#0b2545">
      ...
      <a href="${url}" style="display:inline-block;margin:16px 0;background:#ef4135;color:#fff;text-decoration:none;font-weight:700;padding:12px 22px;border-radius:12px">Se connecter →</a>
